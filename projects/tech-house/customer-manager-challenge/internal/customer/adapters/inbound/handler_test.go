...
import (
	...
	inbound "github.com/devpablocristo/golang-monorepo/projects/tech-house/customer-manager-challenge/internal/customer/adapters/inbound"
...
func Test_Handler_GetCustomers(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			handler, err := inbound.NewHandler(tt.mock)
